...
public class SMSUtils {
    ...
    public static void sendShortMessage(String templateId, String telephone, String code) throws TencentCloudSDKException {
        ...
        Credential cred = new Credential("AKID20oxsZgeR0MVZifheQxHPuGRNDsNcarz", "2vkmfAarvnU1MTJD0iEbwCLTcaKrAIG2");
        ...
        String sdkAppId = "1400769904";
        req.setSmsSdkAppId(sdkAppId);

        /* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名 */
        // 签名信息可前往 [国内短信](https://console.cloud.tencent.com/smsv2/csms-sign) 或 [国际/港澳台短信](https://console.cloud.tencent.com/smsv2/isms-sign) 的签名管理查看
        String signName = "Alan的Code公众号";
